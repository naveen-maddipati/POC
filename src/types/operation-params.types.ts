...
import { DocumentType } from './automation-api.types';

// ==================== DOCUMENT TYPES ====================

/** Document types that can be created by users through the UI */
export type CreatableDocumentType = Extract<DocumentType, 
  | 'Folder'
  | 'File' 
  | 'Note'
  | 'Picture'
